...
export const CardUtil = ({ product, setIsOpen, searchLoad, setSearchLoad }: { product: ProductType, setIsOpen: React.Dispatch<React.SetStateAction<boolean>>, searchLoad: boolean, setSearchLoad: React.Dispatch<React.SetStateAction<boolean>> }) => {
